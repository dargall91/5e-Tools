...
public class CombatTracker extends JFrame {
	...
	private void runEncounter() {
		...
		/*JButton addRein = new JButton("Reinforcements");
		addRein.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JPanel reinPanel = new JPanel();
				reinnPanel.setLayout(new BoxLayout(reinPanel, BoxLayout.X_AXIS));
				reinPanel.setAlignmentX(Component._ALIGNMENT);
				...
				for (Combatant i : combatants) {
					if (i.isReinforcement()) {
						...
						JButton add = new JButton("Add Reinforcement");
						addRein.addActionListener(new ActionListener() {
							@Override
							public void actionPerformed(ActionEvent e) {
				...
				Object[] options = {"DONE"};
				int result = JOptionPane.showOptionDialog(null, panel, "Reinforcements", JOptionPane.PLAIN_MESSAGE,
					JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
			}
		});
		
		panel.add(reinButton);*/
		
		//TODO: add button to finish encounter and restart tracker
